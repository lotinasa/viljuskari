		...
		search: function(widget) {
			var form = widget.find(".car_form_search"),
                ...
                main_params_object = {
                    ...
                    car_doors_count_from: widget.find("[name=car_doors_count_from]").length ? widget.find("[name=car_doors_count_from]").val() : '0',
                    car_doors_count_to: widget.find("[name=car_doors_count_to]").length ? widget.find("[name=car_doors_count_to]").val() : '0',
                    car_interrior_color_from: widget.find("[name=car_interrior_color_from]").length ? widget.find("[name=car_interrior_color_to]").val() : '0',
                    car_interrior_color_to: widget.find("[name=car_interrior_color_from]").length ? widget.find("[name=car_interrior_color_to]").val() : '0',
