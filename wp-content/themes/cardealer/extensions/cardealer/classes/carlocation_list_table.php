...
class Carlocation_List_Table extends WP_List_Table {
	...
	public static function update_cars_location() {
		...
		$slug = wp_unslash( $_REQUEST['slug'] );
		$wpdb->update( 'tmm_cars_locations', array(
			'name' => $name,
			'slug' => $slug
					...
					foreach ( $columns as $column_name => $column_display_name ) {
						...
						switch ( $column_name ) {
							...
							case "name":
								...
								?>
							<td <?php echo $attributes ?>><strong><span class="row-title"
							                                            href="<?php echo $editlink ?>"><?php echo stripslashes( $country['name'] ) ?> </span></strong><br>

								<div class="row-actions">

                                    <span class="inline hide-if-no-js">

                                        <a class="editinline" data-slug="<?php echo stripslashes( $country['slug'] ) ?>"
                                           data-name="<?php echo stripslashes( $country['name'] ) ?>"
                                           data-id="<?php echo stripslashes( $country['id'] ) ?>" href="#">Edit</a> |

                                    </span>

                                    <span class="delete">

                                        <a class="delete-tag" data-name="<?php echo stripslashes( $country['name'] ) ?>"
                                           data-id="<?php echo stripslashes( $country['id'] ) ?>" href="#">Delete</a>
							...
							case "cb" :
								...
								<label class="screen-reader-text"
								       for="cb-select-<?php echo $country['id'] ?>">Select <?php echo $country['name'] ?></label>

								<input id="cb-select-<?php echo $country['id'] ?>" type="checkbox"
								       value="<?php echo $country['id'] ?>" name="delete_tags[]">
